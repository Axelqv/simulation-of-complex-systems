...
%%%%% Plot the delaunay manually with a normal plot!
% for i = 1:N
%     for j = 1:N
%         if Mmatrix(i, j) == 1
...
%             plot([randomVertices(i,1),randomVertices(j,1)],[randomVertices(i,2),randomVertices(j,2)],'k')
%             plot(iPlotx,iPloty,'--')
%             hold on
%             
%         end
...
% figure(k+1)
% roundedPheromoneMatrix = round(pheromoneMatrix);
% triplot(tri)
% hold on
